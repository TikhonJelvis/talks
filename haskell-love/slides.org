...
** 
   Optimization problem: find the policy that maximizes expected reward.
...
** 
   ...
   orderPoint ∷ Int → Int → Policy Int Int
   orderPoint level point = \ inventory →
     if inventory < level 
       then point - inventory 
       else 0
   #+END_SRC
...
** 
   ...
   [[./img/always 0 rewards.svg]]

** 
   =always 1=

   [[./img/always 1 rewards.svg]]
** 
   =always 3=
...
** 
   =orderPoint 0 1=
   [[./img/orderPoint 0 1 rewards.svg]]

** 
   =orderPoint 5 5=
   [[./img/orderPoint 5 5 rewards.svg]]
