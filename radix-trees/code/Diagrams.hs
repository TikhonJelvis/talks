...
renderCTree :: Tree ((Int, C)) -> Diagram B
renderCTree ctree = diagram # translateY 10
                            # pad 1.1
                            # bg white
                            # font "DejaVu Sans Mono"
...
renderCVTree :: Tree ((Int, CV)) -> Diagram B
renderCVTree ctree = diagram # translateY 10
                             # pad 1.1
                             # bg white
                             # font "DejaVu Sans Mono"
  where diagram = renderTree' label edge $ symmLayout' settings ctree
...
wLabel (W 1) = centerX $ circle 1 # bg white
...
renderWTree :: Tree W -> Diagram B
renderWTree t = diagram # translateY 5
                        # pad 1.1
                        # bg white
